...
if(!$installer->tableExists($installer->getTable('multidealpro/deal'))){
	$table = $installer->getConnection()
		...
		->addColumn('qty_start', Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,2', array(
			'nullable'  => false,
			'default'   => '0.00',
			))
		->addColumn('date_from', Varien_Db_Ddl_Table::TYPE_VARCHAR, 30, array(
			'nullable'  => false,
			))
		->addColumn('date_to', Varien_Db_Ddl_Table::TYPE_VARCHAR, 30, array(
			'nullable'  => false,
			))
		->addColumn('status', Varien_Db_Ddl_Table::TYPE_SMALLINT, null, array(
			'nullable'  => true,
			), 'Status')
		->addColumn('qty_sold', Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,2', array(
			'nullable'  => true,
			'default'   => '0.00',
			), 'QTY Sold')
