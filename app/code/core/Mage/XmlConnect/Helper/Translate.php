...
class Mage_XmlConnect_Helper_Translate extends Mage_Core_Helper_Abstract
{
    ...
    public function getLocalizationArray()
    {
        return array(
            ...
            'AccountMyDownloadableProducts' => $this->__('Mis Productos Descargables'),
            ...
            'CreateAccount' => $this->__('Crear una Cuenta'),
            ...
            'CreateAnAccountLabel' => $this->__('Crear una Cuenta'),
            ...
            'LoadingDownloadableProductsProgressTitle' => $this->__('Loading Mis Productos Descargables...'),
